...
def main(args=None):
    ...
    try:
        ...
        final_setting = carla_world.get_settings()
        final_setting.synchronous_mode = False
        final_setting.fixed_delta_seconds = None
        carla_world.apply_settings(final_setting)
        roscomp.shutdown()
        del carla_world
        del carla_client
